...
/*
    ...
    {
	if (msg == 1)
       act( AT_SKILL, "You counter $n's attack.", ch, NULL, victim, TO_VICT    );
    else if (msg == 2)
	   act( AT_SKILL, "You leap back and counter $n's attack.", ch, NULL, victim, TO_VICT );
	else if (msg == 3)
	   act( AT_SKILL, "You barely counter $n's attack!", ch, NULL, victim, TO_VICT );
	else if (msg == 4)
	   act( AT_SKILL, "$n's weapon whistles by you as you counter their attack!", ch, NULL, victim, TO_VICT );
	else if (msg == 5)
	   act( AT_SKILL, "You dextrously counter $n's vicious attack!", ch, NULL, victim, TO_VICT );
    }
    if ( !IS_NPC(ch) && !IS_SET( ch->pcdata->flags, PCFLAG_GAG) )
    {
	if (msg == 1)
       act( AT_SKILL, "$N counters your attack.", ch, NULL, victim, TO_CHAR    );
	else if (msg == 2)
	   act( AT_SKILL, "$N leaps back and counters your attack.", ch, NULL, victim, TO_CHAR );
	else if (msg == 3)
	   act( AT_SKILL, "$N barely counters your attack!", ch, NULL, victim, TO_CHAR );
	else if (msg == 4)
	   act( AT_SKILL, "Your weapon whistles past $N as they counter your attack!", ch, NULL, victim, TO_CHAR );
	else if (msg == 5)
	   act( AT_SKILL, "$N dextrously counters your vicious attack!", ch, NULL, victim, TO_CHAR );
    }
*/
